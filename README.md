...
If you cannot connect to another database, please submit an [issue](https://github.com/nabinhyan/dbt-action/issues) and we'll figure it out.

## Suggested workflow and other tips

Here is a [sample workflow](https://github.com/nabinhyan/dbt-action-sample) that sends dbt console logs by email.

## Bugs and feature requests
Please submit via [Github issues](https://github.com/nabinhyan/dbt-action/issues).
## License
