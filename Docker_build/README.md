...
`docker build --tag ghcr.io/nabinhyan/dbt_all:v1.10.6  --target dbt-all .`

export CR_PAT=ghp_xxxx
echo $CR_PAT | docker login ghcr.io -u nabinhyan --password-stdin

`docker push ghcr.io/nabinhyan/dbt_all:v1.10.6`
